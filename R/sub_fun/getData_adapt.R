...
# seaweeds and other sources that avoid freshwater use  
# 50 
# seaweeds and other sources that do not use freshwater  
# 50 
# improved husbandry methods  
# 200 
# genetic selection for resiliance  
# 200 
# proactive siting/planning to identify resilient farm sites  
# 200 
# reduce other stressors to provide scope for CC stress; improve husbandry  
# 200 
# reduce other stressors to provide scope for CC stress; improve nutrition  
# 200 
# FUN <- function(x){
#   count.occurances <- 0
