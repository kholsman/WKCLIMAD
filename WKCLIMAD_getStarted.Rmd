...
```{r plotResults, echo=TRUE, eval=F, include =T}
   ...
   # loads packages, data, setup, etc.
    ...
    long_mitigat2     <- getData_adapt(mitigat_dat,
                                       lkupIN = mitigat_lkup,
                                       LM  = c("likelihood","magnitude"),
                                       lvls  = c("Low  - My opinion",
                                                  "Medium low - My opinion and some data",
    ...
    # get summaries:
    smry_f1i <- get_smry_impacts(dat = long_f,Sector2 = "Fisheries (1st delphi)", mult = 1.95)
    smry_a1i <- get_smry_impacts(dat = long_a,Sector2 = "Aquaculture (1st delphi)", mult = 1.95)
    smry_f2i <- get_smry_impacts(dat = long_f2,Sector2 = "Fisheries (2nd delphi)", mult = 1.95)
    smry_a2i <- get_smry_impacts(dat = long_a2,Sector2 = "Aquaculture (2nd delphi)", mult = 1.95)
